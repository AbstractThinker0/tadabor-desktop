      ...
      <Flex flexDir={"column"} flex={1} overflow={"auto"}>
        ...
        >
          ...
          <Box>
            ...
            <Text>
              Simply check Quran Browser on the app, you can click the down
              arrow button next to any verse to open a form where you can enter
              your text, once you are done writing you can press the save
              button, all the data will be saved on the application and
